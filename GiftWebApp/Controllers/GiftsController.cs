...
namespace GiftWebApp.Controllers
{
    public class GiftsController : Controller
    {
        ...
        {
            return View("Index",await _context.Gift.Where(j => j.JokeQuestion.Contains(SearchPhrase)).ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,JokeQuestion,JokeAnswer")] Gift gift)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,JokeQuestion,JokeAnswer")] Gift gift)
        {
            if (id != gift.Id)
            {
                return NotFound();
